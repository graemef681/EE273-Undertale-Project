...
int main()
{
	...
	if (!BackgroundTexture.loadFromFile("C:/Users/minusfractions/Documents/Code_For_Easy_Access/background.png"))
	...
	if (!TopTexture.loadFromFile("C:/Users/minusfractions/Documents/Code_For_Easy_Access/topbackground.png"))
		cout << "Texture couldnt be read" << endl;
	else
	...
	if (!nodeTexture.loadFromFile("C:/Users/minusfractions/Documents/Code_For_Easy_Access/node.png"))
		cout << "Texture couldnt be read" << endl;
